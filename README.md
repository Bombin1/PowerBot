# 🔋 PowerBot - Моніторинг світла через Termux

Бот для автоматичного відстеження наявності електроенергії за допомогою старого Android-смартфона. 
Бот працює в середовищі Termux, аналізує статус батареї та миттєво повідомляє про зміни в Telegram.

## ✨ Основні можливості
* 💡 **Сповіщення про світло**: миттєві повідомлення "Світло з'явилось/зникло".
* 📊 **Статус за запитом**: отримання поточного відсотка заряду та температури.
...
* 🔄 **Оновлення в один клік**: вбудована команда `/update` для підтягування змін з GitHub.
...
<b>2.6</b> Збережіть Токен (вдруге ви його ніде не побачите): Це довгий рядок символів <br>(наприклад: 8513142550:AAGxXBZ4Y3Pw8FlVOdOpNys1L4RHkDjsuK0). Нікому не передавайте його!
...
<b>3.5</b> Поверніться назад і натисніть Group Permissions.
...
Як тільки ви його додасте, він напише в чат: "Chat ID: -1003792819819".
...
<b>2.4</b> Також у самому додатку Termux потягніть шторку сповіщень вниз і переконайтеся, що там написано "Acquire wakelock" (це не дає процесору заснути).
...
☕ Підтримка проекту
Якщо бот став вам у пригоді, ви можете подякувати автору:
